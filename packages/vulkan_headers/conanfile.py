...
class vulkan_headers(ConanFile):
	...
	def package_info(self):
		...
		# ${Vulkan_INCLUDE_DIRS}) resolves to these headers with no CMake change.
		# "both" generates a module so the plain find_package(Vulkan) (module mode) resolves too.
		...
		# Headers only.
		# The loader is dlopen'd / LoadLibrary'd at runtime (see vk_instance.c),
		# so there is no import lib to link, which is why this doesn't need an arch-specific SDK.
