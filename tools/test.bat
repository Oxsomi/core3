...
echo )OxC3 hash file -format MD5 -input mytest.tmp.txt
OxC3 hash file -format MD5 -input mytest.tmp.txt
...
echo )OxC3 hash string -format MD5 -input "Hello world"
OxC3 hash string -format MD5 -input "Hello world"
