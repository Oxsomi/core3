...
impl void Log_printCapturedStackTraceCustom(const void **stackTrace, U64 stackSize, LogLevel lvl, LogOptions options);
impl void Log_log(LogLevel lvl, LogOptions options, LogArgs args);

inline void Log_printCapturedStackTrace(const StackTrace stackTrace, LogLevel lvl, LogOptions options) {
