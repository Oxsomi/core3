...
#define vecShufflei(a, x, y, z, w) \
	I32x4_create4(vgetq_lane_s32(a, x), vgetq_lane_s32(a, y), vgetq_lane_s32(a, z), vgetq_lane_s32(a, w))
	
#define vecShufflef(a, x, y, z, w) \
	F32x4_create4(vgetq_lane_f32(a, x), vgetq_lane_f32(a, y), vgetq_lane_f32(a, z), vgetq_lane_f32(a, w))
