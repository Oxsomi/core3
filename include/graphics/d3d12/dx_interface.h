...
#pragma once
	...
	Bool D3D12BLASRef_prepareCompact(GraphicsDeviceRef *deviceRef, BLASRef *blas, Bool *recorded, Error *e_rr);
	Bool D3D12BLASRef_compact(void *commandBuffer, GraphicsDeviceRef *deviceRef, BLASRef *blas, Error *e_rr);
