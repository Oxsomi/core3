...
F32x4 F32x4_div(F32x4 a, F32x4 b) NONE_OP4F(a.v[i] / b.v[i])
...
I32x4 I32x4_mulU32x2AsU64x2(I32x4 a, I32x4 b) NONE_OP4I(
...
I32x4 I32x4_eq(I32x4 a, I32x4 b)  NONE_OP4I(a.v[i] == b.v[i])
I32x2 I32x2_eq(I32x2 a, I32x2 b)  NONE_OP2I(a.v[i] == b.v[i])
F32x4 F32x4_eq(F32x4 a, F32x4 b)  NONE_OP4F((F32)(a.v[i] == b.v[i]))
F32x2 F32x2_eq(F32x2 a, F32x2 b)  NONE_OP2F((F32)(a.v[i] == b.v[i]))

I32x4 I32x4_neq(I32x4 a, I32x4 b) NONE_OP4I(a.v[i] != b.v[i])
I32x2 I32x2_neq(I32x2 a, I32x2 b) NONE_OP2I(a.v[i] != b.v[i])
F32x4 F32x4_neq(F32x4 a, F32x4 b)  NONE_OP4F((F32)(a.v[i] != b.v[i]))
F32x2 F32x2_neq(F32x2 a, F32x2 b)  NONE_OP2F((F32)(a.v[i] != b.v[i]))

I32x4 I32x4_geq(I32x4 a, I32x4 b) NONE_OP4I(a.v[i] >= b.v[i])
I32x2 I32x2_geq(I32x2 a, I32x2 b) NONE_OP2I(a.v[i] >= b.v[i])
F32x4 F32x4_geq(F32x4 a, F32x4 b)  NONE_OP4F((F32)(a.v[i] >= b.v[i]))
F32x2 F32x2_geq(F32x2 a, F32x2 b)  NONE_OP2F((F32)(a.v[i] >= b.v[i]))

I32x4 I32x4_gt(I32x4 a, I32x4 b)  NONE_OP4I(a.v[i] > b.v[i])
I32x2 I32x2_gt(I32x2 a, I32x2 b)  NONE_OP2I(a.v[i] > b.v[i])
F32x4 F32x4_gt(F32x4 a, F32x4 b)  NONE_OP4F((F32)(a.v[i] > b.v[i]))
F32x2 F32x2_gt(F32x2 a, F32x2 b)  NONE_OP2F((F32)(a.v[i] > b.v[i]))

I32x4 I32x4_leq(I32x4 a, I32x4 b) NONE_OP4I(a.v[i] <= b.v[i])
I32x2 I32x2_leq(I32x2 a, I32x2 b) NONE_OP2I(a.v[i] <= b.v[i])
F32x4 F32x4_leq(F32x4 a, F32x4 b)  NONE_OP4F((F32)(a.v[i] <= b.v[i]))
F32x2 F32x2_leq(F32x2 a, F32x2 b)  NONE_OP2F((F32)(a.v[i] <= b.v[i]))

I32x4 I32x4_lt(I32x4 a, I32x4 b)  NONE_OP4I(a.v[i] < b.v[i])
I32x2 I32x2_lt(I32x2 a, I32x2 b)  NONE_OP2I(a.v[i] < b.v[i])
F32x4 F32x4_lt(F32x4 a, F32x4 b)  NONE_OP4F((F32)(a.v[i] < b.v[i]))
F32x2 F32x2_lt(F32x2 a, F32x2 b)  NONE_OP2F((F32)(a.v[i] < b.v[i]))

//Bitwise

I32x4 I32x4_or(I32x4 a, I32x4 b)  NONE_OP4I(a.v[i] | b.v[i])
I32x2 I32x2_or(I32x2 a, I32x2 b)  NONE_OP2I(a.v[i] | b.v[i])

I32x4 I32x4_and(I32x4 a, I32x4 b) NONE_OP4I(a.v[i] & b.v[i])
I32x2 I32x2_and(I32x2 a, I32x2 b) NONE_OP2I(a.v[i] & b.v[i])

I32x4 I32x4_andnot(I32x4 a, I32x4 b) NONE_OP4I((~a.v[i]) & b.v[i])
I32x2 I32x2_andnot(I32x2 a, I32x2 b) NONE_OP2I((~a.v[i]) & b.v[i])

I32x4 I32x4_xor(I32x4 a, I32x4 b) NONE_OP4I(a.v[i] ^ b.v[i])
I32x2 I32x2_xor(I32x2 a, I32x2 b) NONE_OP2I(a.v[i] ^ b.v[i])

I32x2 I32x2_not(I32x2 a) NONE_OP2I(~a.v[i])
I32x4 I32x4_not(I32x4 a) NONE_OP4I(~a.v[i])

//Min/max

I32x4 I32x4_min(I32x4 a, I32x4 b) NONE_OP4I((I32) I64_min(a.v[i], b.v[i]))
I32x2 I32x2_min(I32x2 a, I32x2 b) NONE_OP2I((I32) I64_min(a.v[i], b.v[i]))
F32x4 F32x4_min(F32x4 a, F32x4 b) NONE_OP4F(F32_min(a.v[i], b.v[i]))
F32x2 F32x2_min(F32x2 a, F32x2 b) NONE_OP2F(F32_min(a.v[i], b.v[i]))

I32x4 I32x4_max(I32x4 a, I32x4 b) NONE_OP4I((I32) I64_max(a.v[i], b.v[i]))
I32x2 I32x2_max(I32x2 a, I32x2 b) NONE_OP2I((I32) I64_max(a.v[i], b.v[i]))
F32x4 F32x4_max(F32x4 a, F32x4 b) NONE_OP4F(F32_max(a.v[i], b.v[i]))
F32x2 F32x2_max(F32x2 a, F32x2 b) NONE_OP2F(F32_max(a.v[i], b.v[i]))
...
F32x4 F32x4_ceil(F32x4 a) NONE_OP4F(F32_ceil(a.v[i]))
F32x2 F32x2_ceil(F32x2 a) NONE_OP2F(F32_ceil(a.v[i]))

F32x4 F32x4_floor(F32x4 a) NONE_OP4F(F32_floor(a.v[i]))
F32x2 F32x2_floor(F32x2 a) NONE_OP2F(F32_floor(a.v[i]))

F32x4 F32x4_round(F32x4 a) NONE_OP4F(F32_round(a.v[i]))
F32x2 F32x2_round(F32x2 a) NONE_OP2F(F32_round(a.v[i]))

F32x4 F32x4_sqrt(F32x4 a) NONE_OP4F(F32_sqrt(a.v[i]))
F32x2 F32x2_sqrt(F32x2 a) NONE_OP2F(F32_sqrt(a.v[i]))

F32x4 F32x4_rsqrt(F32x4 a) NONE_OP4F(1 / F32_sqrt(a.v[i]))
F32x2 F32x2_rsqrt(F32x2 a) NONE_OP2F(1 / F32_sqrt(a.v[i]))

F32x4 F32x4_acos(F32x4 a) NONE_OP4F(F32_acos(a.v[i]))
F32x2 F32x2_acos(F32x2 a) NONE_OP2F(F32_acos(a.v[i]))

F32x4 F32x4_cos(F32x4 a) NONE_OP4F(F32_cos(a.v[i]))
F32x2 F32x2_cos(F32x2 a) NONE_OP2F(F32_cos(a.v[i]))

F32x4 F32x4_asin(F32x4 a) NONE_OP4F(F32_asin(a.v[i]))
F32x2 F32x2_asin(F32x2 a) NONE_OP2F(F32_asin(a.v[i]))

F32x4 F32x4_sin(F32x4 a) NONE_OP4F(F32_sin(a.v[i]))
F32x2 F32x2_sin(F32x2 a) NONE_OP2F(F32_sin(a.v[i]))

F32x4 F32x4_atan(F32x4 a) NONE_OP4F(F32_atan(a.v[i]))
F32x2 F32x2_atan(F32x2 a) NONE_OP2F(F32_atan(a.v[i]))

F32x4 F32x4_atan2(F32x4 a, F32x4 x) NONE_OP4F(F32_atan2(a.v[i], x.v[i]))
F32x2 F32x2_atan2(F32x2 a, F32x2 x) NONE_OP2F(F32_atan2(a.v[i], x.v[i]))

F32x4 F32x4_tan(F32x4 a)  NONE_OP4F(F32_tan(a.v[i]))
F32x2 F32x2_tan(F32x2 a)  NONE_OP2F(F32_tan(a.v[i]))

F32x4 F32x4_loge(F32x4 a)  NONE_OP4F(F32_loge(a.v[i]))
F32x2 F32x2_loge(F32x2 a)  NONE_OP2F(F32_loge(a.v[i]))

F32x4 F32x4_log10(F32x4 a)  NONE_OP4F(F32_log10(a.v[i]))
F32x2 F32x2_log10(F32x2 a)  NONE_OP2F(F32_log10(a.v[i]))

F32x4 F32x4_log2(F32x4 a)  NONE_OP4F(F32_log2(a.v[i]))
F32x2 F32x2_log2(F32x2 a)  NONE_OP2F(F32_log2(a.v[i]))
...
F32x4 F32x4_exp(F32x4 a) NONE_OP4F(F32_expeInternal(a.v[i]))
F32x2 F32x2_exp(F32x2 a) NONE_OP2F(F32_expeInternal(a.v[i]))

F32x4 F32x4_exp10(F32x4 a) NONE_OP4F(F32_exp10Internal(a.v[i]))
F32x2 F32x2_exp10(F32x2 a) NONE_OP2F(F32_exp10Internal(a.v[i]))

F32x2 F32x2_exp2(F32x2 a) NONE_OP2F(F32_exp2Internal(a.v[i]))
F32x4 F32x4_exp2(F32x4 a) NONE_OP4F(F32_exp2Internal(a.v[i]))
...
I32x4 I32x4_lsh32(I32x4 a, U8 bits) NONE_OP4I((I32)(bits >= 32 ? 0 : (U32)a.v[i] << bits))
I32x4 I32x4_rsh32(I32x4 a, U8 bits) NONE_OP4I((I32)(bits >= 32 ? 0 : (U32)a.v[i] >> bits))
