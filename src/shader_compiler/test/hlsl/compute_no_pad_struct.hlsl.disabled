//Not in use until DXIL and SPIRV match layout for nest0 -> c:
//$Element->c
//SPIRV: 0x00000008: c (SPIRV & DXIL: Unused): U64
//DXIL:  0x00000004: c (DXIL: Used): U64
...
StructuredBuffer<float4x3[3]> _sbuffer1;
