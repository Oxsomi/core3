...
OXC3_TEST_MAIN(formats_obj) {
	...
	Test_objCoverageFlags(&t);
	Test_objUvPrecision(&t);
	Test_objWriteRoundTrip(&t);
	Test_objWriteQuantized(&t);
	Test_objWriteGeometryOnly(&t);
